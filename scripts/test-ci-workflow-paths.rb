...
cases = {
  ...
  'scripts/verify-native-package-proof-snapshot.mjs' => [%w[app contracts], %w[app contracts]],
  'scripts/test-native-package-proof-snapshot.mjs' => [%w[app contracts], %w[app contracts]],
