...
SCRIPT = Path(__file__).with_name("setup-opensuse-repository.sh")
...
class BootstrapTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.temporary = tempfile.TemporaryDirectory(prefix="loopwire-opensuse-bootstrap-")
        ...
        run("gpg", "--batch", "--homedir", str(cls.home), "--pinentry-mode", "loopback", "--passphrase", "",
            "--quick-generate-key", "Loopwire openSUSE fixture <fixture@example.invalid>", "rsa2048", "sign", "1d")
