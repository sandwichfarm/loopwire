...
assert_contains "apps/docs/docs/guide/configurations.md" "again before every live device switch"
...
assert_contains "apps/docs/docs/guide/configurations.md" "Editing a device while live apply is armed disarms it"
assert_contains "apps/docs/docs/guide/configurations.md" "re-arm in Settings"
