...
assert_contains "apps/docs/docs/developer/release.md" "--print-env-template > /secure/loopwire-release-secrets.env"
assert_contains "apps/docs/docs/developer/release.md" "no-value template from the helper"
