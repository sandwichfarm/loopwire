...
assert_contains "apps/docs/docs/guide/configurations.md" "Changing the selected backend immediately re-verifies"
...
assert_contains "apps/docs/docs/developer/release.md" "tag resolves to the current checkout commit"
