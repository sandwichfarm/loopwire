...
assert_contains "apps/docs/docs/index.md" "alt=\"Loopwire desktop shell with saved configurations"
assert_contains "apps/docs/docs/index.md" "backend prompt, route controls, outputs, and monitors."
...
assert_contains "README.md" "Configuration export/import and the on-demand diagnostics panel are back in the rebuilt desktop UI"
assert_contains "README.md" "disclosure under Settings → Audio Backend lists each backend capability report"
...
assert_contains "apps/docs/docs/developer/screenshots.md" "pnpm verify:desktop-preview"
assert_contains "apps/docs/docs/developer/screenshots.md" "--skip-if-missing"
...
assert_contains "apps/docs/docs/developer/release.md" "If a PEM block is pasted"
