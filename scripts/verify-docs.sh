...
required_files=(
  ...
  "apps/docs/docs/developer/e2e.md"
  "apps/docs/docs/developer/github-actions-setup.md"
  ...
  "apps/docs/docs/public/product-screenshot.png"
)
...
if ! cmp -s "$root/assets/product-screenshot.png" "$root/apps/docs/docs/public/product-screenshot.png"; then
  echo "Public docs screenshot must stay byte-for-byte synced with assets/product-screenshot.png" >&2
  exit 1
fi
...
assert_contains "apps/docs/docs/index.md" "/product-screenshot.png"
assert_contains "apps/docs/docs/index.md" "/guide/basic-usage"
assert_contains "apps/docs/docs/index.md" "Support and release proof"
assert_contains "apps/docs/docs/guide/basic-usage.md" "Pass-Thru"
assert_contains "apps/docs/docs/guide/basic-usage.md" "Ctrl+,"
assert_contains "apps/docs/docs/guide/basic-usage.md" "Browser"
assert_contains "apps/docs/docs/guide/basic-usage.md" "preview mode"
assert_contains "packaging/README.md" "same release artifacts"
assert_contains "packaging/README.md" "loopwire-dsp-provider"
assert_contains "packaging/README.md" "loopwire-jack-ports"
assert_contains "README.md" "assets/product-screenshot.png"
assert_contains "README.md" "Loopwire is a Linux virtual audio routing app"
assert_contains "README.md" "Basic usage / first route"
assert_contains "README.md" "pnpm build:web"
assert_contains "README.md" "curl -fsSL https://loopwire.app/install.sh | bash"
assert_contains "README.md" "platform-detecting installer"
assert_contains "README.md" "https://loopwire.app/docs/guide/basic-usage.html"
assert_contains "README.md" "ALSA is detection-only"
assert_contains "apps/docs/docs/developer/release.md" "combined Astro homepage plus"
assert_contains "apps/docs/docs/developer/release.md" "VitePress docs tree"
assert_contains "apps/docs/docs/developer/release.md" "--dist dist/site"
...
assert_contains "apps/docs/docs/guide/backends.md" "LOOPWIRE_JACK_PORTS_DELEGATE_MODE=detached"
assert_contains "apps/docs/docs/guide/backends.md" "--jack-provider-delegate-mode detached"
...
assert_contains "apps/docs/docs/guide/backends.md" "hydrates the backend picker in Settings"
assert_contains "apps/docs/docs/guide/backends.md" "saved for live apply and startup restore"
assert_contains "apps/docs/docs/guide/backends.md" "Unavailable candidates stay listed with the reason"
...
assert_contains "apps/docs/docs/guide/configurations.md" "grouped ⊕ menu"
assert_contains "apps/docs/docs/guide/configurations.md" "Hiding is a view state"
assert_contains "apps/docs/docs/guide/configurations.md" "reappear on **Show Monitors**"
...
assert_contains "apps/docs/docs/guide/configurations.md" "host sink name they were created from"
assert_contains "apps/docs/docs/guide/configurations.md" "Monitors added from the playback-device menu"
assert_contains "apps/docs/docs/guide/configurations.md" "drag from an output port to a compatible input port"
assert_contains "apps/docs/docs/guide/configurations.md" "click a cable to select its route"
...
assert_contains "apps/docs/docs/guide/configurations.md" "as error toasts and in the backend status line"
assert_contains "apps/docs/docs/guide/configurations.md" "source volume back to 100%"
assert_contains "apps/docs/docs/guide/configurations.md" "Host audio changes only through the explicit apply path"
assert_contains "apps/docs/docs/guide/configurations.md" "non-100% gain"
assert_contains "apps/docs/docs/guide/configurations.md" "runs a static preflight"
assert_contains "apps/docs/docs/guide/configurations.md" "removing an endpoint prunes its routes"
assert_contains "apps/docs/docs/guide/configurations.md" "Manual host-binding overrides live in each card's"
assert_contains "apps/docs/docs/guide/configurations.md" "Clearing the field removes the override"
assert_contains "apps/docs/docs/guide/configurations.md" "re-applies the selected device so the host graph tracks"
assert_contains "apps/docs/docs/guide/configurations.md" "**Settings → Transfer** exports the selected device to this format"
assert_contains "apps/docs/docs/guide/configurations.md" "imports a pasted export as a new device"
assert_contains "apps/docs/docs/guide/basic-usage.md" "**Transfer** exports the selected device as versioned JSON"
assert_contains "apps/docs/docs/guide/basic-usage.md" "**Diagnostics** lists backend capability reports."
assert_contains "apps/docs/docs/guide/configurations.md" "collapses the Monitors column for the current device"
assert_contains "apps/docs/docs/guide/configurations.md" "Before every live device switch"
assert_contains "apps/docs/docs/guide/configurations.md" "cables are preserved"
assert_contains "apps/docs/docs/guide/configurations.md" "that detection reports unavailable"
assert_contains "apps/docs/docs/guide/configurations.md" "it can route each source to only one output"
assert_contains "apps/docs/docs/guide/configurations.md" "PulseAudio fan-out routes"
...
assert_contains "apps/docs/docs/guide/configurations.md" "applied to the host on the next device selection or startup"
assert_contains "apps/docs/docs/guide/configurations.md" "Host apply is automatic"
...
assert_contains "apps/docs/docs/guide/configurations.md" "as the saved startup-restore choice"
assert_contains "apps/docs/docs/guide/configurations.md" "only after the active configuration verifies against it"
assert_contains "apps/docs/docs/guide/configurations.md" "stay disabled while a backend-change transaction is in flight"
assert_contains "apps/docs/docs/guide/configurations.md" "runs a backend-change transaction in preview mode"
...
assert_contains "apps/docs/docs/guide/start-on-boot.md" "Start with desktop session"
assert_contains "apps/docs/docs/guide/start-on-boot.md" "Restore audio in background"
assert_contains "apps/docs/docs/guide/start-on-boot.md" "the enable path is blocked instead of writing a unit"
assert_contains "apps/docs/docs/guide/start-on-boot.md" "saved backend is no longer detected"
assert_contains "apps/docs/docs/guide/start-on-boot.md" "restore units can still be disabled"
...
assert_contains "apps/docs/docs/guide/start-on-boot.md" "choose the device you want"
...
assert_contains "apps/docs/docs/guide/install.md" "packaging/aur/loopwire-git/PKGBUILD.in"
...
assert_contains "apps/docs/docs/guide/support-matrix.md" 'AUR `loopwire-git`'
assert_contains "apps/docs/docs/developer/release.md" "pnpm verify:aur:source"
assert_contains "apps/docs/docs/developer/release.md" "pnpm verify:aur:git"
...
assert_contains "apps/docs/docs/developer/screenshots.md" "assets/product-screenshot.png"
assert_contains "apps/docs/docs/developer/screenshots.md" "/product-screenshot.png"
assert_contains "apps/docs/docs/developer/screenshots.md" "do not hide the product screenshot"
assert_contains "apps/docs/docs/developer/screenshots.md" "pnpm e2e:ui"
assert_contains "apps/docs/docs/.vitepress/config.ts" "/developer/e2e"
assert_contains "apps/docs/docs/.vitepress/config.ts" "/developer/github-actions-setup"
assert_contains "apps/docs/docs/developer/e2e.md" "pnpm e2e:ui"
assert_contains "apps/docs/docs/developer/github-actions-setup.md" "Windows, macOS, and Linux"
assert_contains "apps/docs/docs/developer/github-actions-setup.md" "FTP & API Access"
assert_contains "apps/docs/docs/developer/github-actions-setup.md" "never trimmed"
assert_contains "apps/docs/docs/developer/github-actions-setup.md" "48 KB"
assert_contains "apps/docs/docs/developer/github-actions-setup.md" "pnpm setup:github"
assert_contains "README.md" "github-actions-setup.html"
assert_contains "apps/docs/docs/developer/e2e.md" "pnpm e2e:shell"
assert_contains "apps/docs/docs/developer/e2e.md" "loopwire.state.v1"
assert_contains "apps/docs/docs/developer/e2e.md" "asserts preview-mode behavior only"
assert_contains "apps/docs/docs/developer/e2e.md" "WebKitWebDriver"
assert_contains "apps/docs/docs/developer/e2e.md" "cargo install tauri-driver --locked"
assert_contains "apps/docs/docs/developer/e2e.md" "refuses to fake a result"
assert_contains "apps/docs/docs/release-notes/unreleased.md" "pnpm e2e:ui"
...
assert_contains "apps/docs/docs/developer/vm-matrix.md" "verify-handoffs"
...
assert_contains "apps/docs/docs/developer/release.md" "verify-output, and clear-output operation rows"
assert_contains "apps/docs/docs/developer/release.md" "verify-output, and clear-output rows"
...
assert_contains "apps/docs/docs/release-notes/unreleased.md" "stale saved backend"
...
assert_contains "apps/docs/docs/release-notes/unreleased.md" "descriptive alt text"
...
assert_contains "apps/docs/docs/release-notes/unreleased.md" "--print-env-template"
assert_contains "apps/docs/docs/release-notes/unreleased.md" "--write-env-template"
assert_contains "apps/docs/docs/release-notes/unreleased.md" '`0600` permissions'
...
assert_contains "apps/docs/docs/release-notes/unreleased.md" "Support bundles can now include read-only DSP provider plan summaries"
assert_contains "apps/docs/docs/release-notes/unreleased.md" "without running provider execute mode"
assert_contains "apps/docs/docs/release-notes/unreleased.md" "VM evidence verification now checks the nested support-bundle command ledger"
...
assert_contains "apps/docs/docs/release-notes/unreleased.md" "detached mode"
assert_contains "apps/docs/docs/release-notes/unreleased.md" "JACK provider delegate mode"
