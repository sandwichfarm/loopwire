...
These notes describe the `v0.1.0` release contents. Artifact, package-channel, and VM compatibility claims remain tied
to the release workflow, signed checksums, final proof workflow, and support-matrix evidence.
