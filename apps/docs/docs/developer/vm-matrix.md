...
verifier. Screenshot evidence must be a decodable, non-interlaced PNG with valid chunk CRCs, image data, and
desktop-sized dimensions; header-only, truncated, or CRC-corrupt PNG placeholders are rejected.
