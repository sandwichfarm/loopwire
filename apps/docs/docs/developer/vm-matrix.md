...
verifier. Screenshot evidence must be a decodable, non-interlaced PNG with image data and desktop-sized dimensions;
header-only or truncated PNG placeholders are rejected.
